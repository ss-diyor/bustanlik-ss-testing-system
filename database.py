...
def delete_all_data():
    ...
    cur.execute("DELETE FROM appeals")          # appeals → talabalar ga bog'liq
    cur.execute("DELETE FROM access_requests")  # access_requests → talabalar ga bog'liq
    cur.execute("DELETE FROM test_natijalari")  # test_natijalari → talabalar ga bog'liq
    cur.execute("DELETE FROM talabalar")        # endi xavfsiz o'chirish mumkin
