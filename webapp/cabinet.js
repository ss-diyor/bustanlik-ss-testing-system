...
function renderServices(){
  ...
  document.getElementById('pageContent').innerHTML=`<section class="services-hero"><div><div class="eyebrow">KABINET XIZMATLARI</div><h2>Profil va sozlamalar</h2><p>Shaxsiy ma’lumotlar, QR-kod, xabarlar va yordam xizmatlarini boshqaring.</p></div><div class="services-status"><i></i><span>${linked?'Telegram ulangan':'Telegram ulanmagan'}</span></div></section><div class="service-grid services-grid"><button class="service-button" data-service="profile"><span>◌</span><b>Shaxsiy profil</b><small>Kabinet va Telegram ma’lumotlari</small></button><button class="service-button" data-service="qr"><span>▦</span><b>Mening QR-kodim</b><small>Ko‘rish va qurilmaga yuklash</small></button><button class="service-button" data-service="notifications"><span>◉</span><b>Bildirishnomalar</b><small>Xabar turlarini boshqarish</small></button><button class="service-button" data-service="contact"><span>✎</span><b>Admin bilan bog‘lanish</b><small>Yordam uchun murojaat yuborish</small></button><button class="service-button danger-service" data-service="session"><span>→</span><b>Kabinetdan chiqish</b><small>Joriy sessiyani yakunlash</small></button><div id="serviceDetail" class="service-detail services-detail"></div></div>`;
